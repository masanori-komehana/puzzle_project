...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public boolean addResult(int resigned){
        Pazzle p = Pazzle.getInstance();
        int player_id = getCurrentPlayer().player_id;
        int pazzletime = p.getPazzletime();
        int movecount = p.getMoved();
        return resultItemQuery.add(player_id, pazzletime, movecount, resigned);
    }

    public ResultItem getResultLatest(){
        return resultItemQuery.getLatest();
    }



//    public int getRank(RankType rt){
//        int rank = 1;
//        String query;
//        switch (rt){
//            case Moves:

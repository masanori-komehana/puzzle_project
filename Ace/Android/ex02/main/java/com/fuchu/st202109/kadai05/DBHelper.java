...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private final PlayerItem.Factory playerItemFactory = new PlayerItem.Factory(this);
    private final ResultItem.Factory resultItemFactory = new ResultItem.Factory(this);
    ...
    public List<ResultItem> getResultAll(){
        return resultItemFactory.createAll();
    }

    public List<ResultItem> getPlayerResults(PlayerItem player){
        return resultItemFactory.createWithPlayer(player);
    }

    public ResultItem getResult(int id){
        return resultItemFactory.create(id);
    }
    ...
    public PlayerItem getPlayer(int player_id){
        if (hasPlayer(player_id)){
            return playerItemFactory.create(player_id);
        }
        return null;
    }
    ...
    public PlayerItem getPlayer(String name){
        if (hasPlayer(name)){
            return playerItemFactory.create(name);
        }
        return null;
    }
    ...
    public List<PlayerItem> getPlayerAll(){
        return playerItemFactory.createAll();
    }
